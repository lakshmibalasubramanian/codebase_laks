...
imageCalculator("Subtract create stack", "PVM.labels","C2-dupli_image-2"); //$ CD13/BC channel
...
rename("C3-dupli_image");   //$ Phalloidin channel
setTool("freehand");
...
selectWindow("Infected_cell.labels");
imageCalculator("Subtract create stack", "Infected_cell.labels","C2-dupli_image-2"); //$ CD13/BC channel
