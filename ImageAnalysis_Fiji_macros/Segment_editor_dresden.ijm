...
selectWindow("C2-dupli_image"); //$ CD13 channel
run("Green");
run("Smooth", "stack");
run("Smooth", "stack");
run("Threshold...");
...
//saveAs("Tiff",output1+"C2-dupli_image.tif"); //$ CD13 channel

run("AVI... ", "frame=10 save=["+output1+"C2-dupli_image.avi]"); //$ CD13 channel
...
rename("PVM.labels");
//run("Duplicate...", "title=dupli_PVM");
//selectWindow("dupli_PVM");
//saveAs("Tiff",output1+"PVM.labels.tif");
...
selectWindow("PVM.labels");
imageCalculator("Subtract create stack", "PVM.labels","C2-dupli_image"); //$ CD13 channel
...
//run("Duplicate...", "title=dupli_PVM_BC_surface");
//selectWindow("dupli_PVM_BC_surface");
//saveAs("Tiff",output1+"PVM_BC_surface.tif");
...
//run("Duplicate...", "title=dupli_infec_cell");
//selectWindow("dupli_infec_cell");
//saveAs("Tiff",output1+"Infected_cell_labels.tif");
...
selectWindow("Infected_cell.labels");
imageCalculator("Subtract create stack", "Infected_cell.labels","C2-dupli_image"); //$ CD13 channel
...
//run("Duplicate...", "title=dupli_infec_cell_BC");
//saveAs("Tiff",output1+"Infec_Cells_BC_surface.tif");
...
{   
	...
	//saveAs("Tiff",output1+n+"Uninfected_cell_labels.tif");
	...
	imageCalculator("Subtract create stack", ""+n+"Uninfected_cell.labels","C2-dupli_image"); //$ CD13 channel
	...
	//saveAs("Tiff",output1+n+"Uninf_Cells_BC_surface.tif");
