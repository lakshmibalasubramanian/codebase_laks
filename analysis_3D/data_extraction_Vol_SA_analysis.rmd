...
for (m in 1:length(folder_list)){   # This is the main loop which has two timepoints folder
  ...
  for (j in 1:length(file_timepoint)){
    ...
    loca_uninf[[j]] <- 
      cbind(
            ...
            lapply(dat_saBC_int_intensity_uninf, function(x) x[[6]] %>% sum()) %>% as.matrix(),
  ...
  for (k in 1:length(file_timepoint)){
    ...
    colnames(tot_dat_inf[[k]]) <- c("cell_Vol", "Surf_Voxels","Surf_Pixel", "int_intensity","int_intensity_SA","saBC_SA", "saBC_SV", "Status","File Name","Timepoint")
    ...
    colnames(tot_dat_pvm[[k]]) <- c("cell_Vol", "Surf_Voxels","Surf_Pixel", "int_intensity","int_intensity_SA","saBC_SA", "saBC_SV", "Status","File Name","Timepoint")
    ...
    colnames(tot_dat_uninf[[k]]) <- c("cell_Vol", "Surf_Voxels","Surf_Pixel", "int_intensity","int_intensity_SA","saBC_SA", "saBC_SV", "Status","File Name","Timepoint")
   }
