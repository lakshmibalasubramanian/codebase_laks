...
#Replacing all the BC data to NA in 33hpi
total_all$BC_SA_Pix[total_all$Timepoint == "33hpi"] <- NA
total_all$BC_SA_Vox[total_all$Timepoint == "33hpi"] <- NA
total_all$BC_int_intensity[total_all$Timepoint == "33hpi"] <- NA

#Writing the dataframes as .csv in a file
