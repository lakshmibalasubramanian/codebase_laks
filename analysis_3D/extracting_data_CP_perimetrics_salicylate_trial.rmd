...
#Declaring the path
base_path <- "/media/lab-admin/VS_lab_disk/cellprofiler_perimetrics_salicylate_trail"
...
for (m in 1:length(folders_hpi)){
  ...
  file_names1 <- gsub("/media/lab-admin/VS_lab_disk/cellprofiler_perimetrics_salicylate_trail", "",file_names)
 ...
 write.csv(dat_tot_int, file = "/media/lab-admin/VS_lab_disk/cellprofiler_perimetrics_salicylate_trail/Data_CP_perimetrics_salicylate_master.csv")
 ...
 write.csv(dat_area_pvm, file = "/media/lab-admin/VS_lab_disk/cellprofiler_perimetrics_salicylate_trail/Data_area_PVM_salicylate_master.csv")
```
