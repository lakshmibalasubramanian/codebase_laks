...
tes_BC_inf_uninf_24 <- t.test(dat_24_inf %>% dplyr::select(dat_24_inf$BC_SA_Vox) %>% as.matrix(), dat_24_uninf %>% dplyr::select(dat_24_uninf$BC_SA_Vox) %>% as.matrix(), alternative = c("two.sided"), paired = FALSE, var.equal = FALSE, conf.level = 0.95)
