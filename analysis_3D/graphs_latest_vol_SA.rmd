...
ggplot2::ggplot(dat_inf_uninf) +
  ...
  ggplot2::ggsave("volume_inf_hepatocyte1.png", path = "/home/lab-admin/LAKSHMI/SurfaceArea_analysis_new_Jun17/Analysis_SA_vol/", width = 8, height = 8, units = "in", dpi = 300) +
  ggplot2::ggsave("volume_inf_hepatocyte1.svg", path = "/home/lab-admin/LAKSHMI/SurfaceArea_analysis_new_Jun17/Analysis_SA_vol/", width = 8, height = 8, units = "in", dpi = 300)
```
