...
dat_33_all$Timepoint_new <- "NA"
dat_33_all$Timepoint_new <- "33hpi"
colnames(dat_33_all)[11] <- "Treatment"
dat_33_all <- as.data.frame(sapply(dat_33_all,gsub,pattern="Ctrl2",replacement="Untreated"))
dat_33_all <- as.data.frame(sapply(dat_33_all,gsub,pattern="Ctrl3",replacement="Untreated"))
dat_33_all <- as.data.frame(sapply(dat_33_all,gsub,pattern="Sal3_",replacement="Treated"))
dat_33_all <- as.data.frame(sapply(dat_33_all,gsub,pattern="Sal2_",replacement="Treated"))
dat_33_all <- as.data.frame(sapply(dat_33_all,gsub,pattern="Sal1_",replacement="Treated"))

dat_24_48 <- dat
dat_24_48 <- na.omit(dat_24_48)
dat_24_48$Treatment <- "Untreated"
colnames(dat_24_48)[11] <- "Timepoint_new"
