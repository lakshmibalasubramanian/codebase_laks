...
dat <- readr::read_csv("/Volumes/LAKSHMI2/Lakshmi_working_data_new/SurfaceArea_analysis_new_Jun17/Analysis_SA_vol_24_48/master_data.csv")
#dat$BC_SA_Vox <- dat$BC_SA_Vox/2 #This division by 2 is to consider the voxel just touching the pvm/hepatocytes

dat_33 <- readr::read_csv("/Volumes/LAKSHMI2/Lakshmi_working_data_new/Experiment6_images/Analysis_SA_vol/master_data.csv")
...
ggplot2::ggplot(dat_PVM) +
  ...
  ggplot2::ggsave("volume_PVM_jul18_new.png", path = "/Volumes/LAKSHMI2/Lakshmi_working_data/Images_Zstack/Experiment6_images/Analysis_SA_Vol/", width = 4, height = 5, units = "in", dpi = 300) +
  ggplot2::ggsave("volume_PVM_jul18_new.svg", path = "/Volumes/LAKSHMI2/Lakshmi_working_data/Images_Zstack/Experiment6_images/Analysis_SA_Vol/", width = 4, height = 5, units = "in", dpi = 300)
...
ggplot2::ggplot(dat_PVM) +
  ...
  ggplot2::geom_jitter(ggplot2::aes(Timepoint, y = BC_SA_Vox, fill = Status), colour = "red",cex = 2.5, alpha = 0.7, position = position_jitterdodge(0.2,0.2,1.0)) + 
  ggplot2::theme_bw() + theme(axis.text = element_text(size=14, face = "bold", colour = "black")) +
  scale_x_discrete(expand=c(0,0)) +
  ...
  ggplot2::ggsave("BC_PVM_jul18_new.png", path = "/Volumes/LAKSHMI2/Lakshmi_working_data_new/Experiment6_images/Analysis_SA_Vol/", width = 4, height = 5, units = "in", dpi = 300) +
  ggplot2::ggsave("BC_PVM_jul18_new.svg", path = "/Volumes/LAKSHMI2/Lakshmi_working_data_new/Experiment6_images/Analysis_SA_Vol/", width = 4, height = 5, units = "in", dpi = 300)
