...
dat <- readr::read_csv("/media/lab-admin/data/Lakshmi/Tubeness_infected_uninfected/Analysis/salicylate_data_master.csv")  # Input file i.e.csv: Change the input file accordingly 
...
ggplot2::ggplot(dat_5pix) +
  ggplot2::geom_boxplot(ggplot2::aes(Status1, Numberofbranches, fill = Cell_status), size = 1.0, alpha = 0.0, width = 0.4, position = position_dodge(width = 0.7), varwidth = F, notch = T, outlier.shape = NA, show.legend = FALSE) +
  ggplot2::geom_jitter(ggplot2::aes(Status1, y = Numberofbranches, color = Cell_status1), cex = 2.0, alpha = 0.7, position = position_jitterdodge(0.2,0.2,0.7)) + P + 
  ggplot2::theme_bw() + theme(axis.text = element_text(size=14, colour = "black")) +
  theme(axis.title = element_text(size=15, face = "bold"), panel.grid.major.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.minor.y = element_blank(), legend.title = element_blank(), legend.position = c(0.2,0.9), legend.direction = "horizontal", legend.box.background = element_rect(size = 1.0)) +ylab("Number of branch points in Bile canaliculi") + xlab("Salicylate treatment") +
  ggplot2::ggsave("Branch_Points_5pix1.png", path = "/media/lab-admin/data/Lakshmi/Tubeness_infected_uninfected/Analysis/graphs_new_dec17", width = 8, height = 8, units = "in", dpi = 300)+
  ggplot2::ggsave("Branch_Points_5pix1.svg", path = "/media/lab-admin/data/Lakshmi/Tubeness_infected_uninfected/Analysis/graphs_new_dec17", width = 8, height = 8, units = "in", dpi = 300)
```
...
# Inside "geom_jitter" aes give the "shape = column name(Set)" to different the various experiments
ggplot2::ggplot(dat_5pix) +
  ggplot2::geom_boxplot(ggplot2::aes(Status1, Averagebranchlength, fill = Cell_status), size = 1.0, alpha = 0.0, width = 0.4, position = position_dodge(width = 0.7), varwidth = F, notch = T, outlier.shape = NA, show.legend = FALSE) +
  ggplot2::geom_jitter(ggplot2::aes(Status1, y = Averagebranchlength, color = Cell_status1), cex = 2.0, alpha = 0.7, position = position_jitterdodge(0.2,0.2,0.7)) + P +
  ggplot2::theme_bw() + theme(axis.text = element_text(size=14, colour = "black")) +
  theme(axis.title = element_text(size=15, face = "bold"), panel.grid.major.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.minor.y = element_blank(), legend.title = element_blank(), legend.position = c(0.2,0.9), legend.direction = "horizontal", legend.box.background = element_rect(size = 1.0)) + ylab("Average branch length\nof Bile canaliculi (microns)") + xlab("Salicylate treatment") +
  ggplot2::ggsave("Avg_branch_length_5pix1.png", path = "/media/lab-admin/data/Lakshmi/Tubeness_infected_uninfected/Analysis/graphs_new_dec17", width = 8, height = 8, units = "in", dpi = 300)+
  ggplot2::ggsave("Avg_branch_length_5pix1.svg", path = "/media/lab-admin/data/Lakshmi/Tubeness_infected_uninfected/Analysis/graphs_new_dec17", width = 8, height = 8, units = "in", dpi = 300)
```
...
# Inside "geom_jitter" aes give the "shape = column name(Set)" to different the various experiments
ggplot2::ggplot(dat_5pix) +
  ggplot2::geom_boxplot(ggplot2::aes(Status1, `MeanBC(tube)diameter`, fill = Cell_status), size = 1.0, alpha = 0.0, width = 0.4, position = position_dodge(width = 0.7), varwidth = F, notch = T, outlier.shape = NA, show.legend = FALSE) +
  ggplot2::geom_jitter(ggplot2::aes(Status1, y = `MeanBC(tube)diameter`, color = Cell_status1), cex = 2.0, alpha = 0.7, position = position_jitterdodge(0.2,0.2,0.7)) + P +
  ggplot2::theme_bw() + theme(axis.text = element_text(size=14, colour = "black")) +
  theme(axis.title = element_text(size=15, face = "bold"), panel.grid.major.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.minor.y = element_blank(), legend.title = element_blank(), legend.position = c(0.2,0.9), legend.direction = "horizontal", legend.box.background = element_rect(size = 1.0)) + ylab("Diameter of Bile canaliculi (microns)") + xlab("Salicylate treatment") +
  ggplot2::ggsave("BC_diameter_5pix1.png", path = "/media/lab-admin/data/Lakshmi/Tubeness_infected_uninfected/Analysis/graphs_new_dec17", width = 8, height = 8, units = "in", dpi = 300)+
  ggplot2::ggsave("BC_diameter_5pix1.svg", path = "/media/lab-admin/data/Lakshmi/Tubeness_infected_uninfected/Analysis/graphs_new_dec17", width = 8, height = 8, units = "in", dpi = 300)
```
...
# Inside "geom_jitter" aes give the "shape = column name(Set)" to different the various experiments
ggplot2::ggplot(dat_5pix) +
  ggplot2::geom_boxplot(ggplot2::aes(Status1, TotalBCvolume, fill = Cell_status), size = 1.0, alpha = 0.0, width = 0.4, position = position_dodge(width = 0.7), varwidth = F, notch = T, outlier.shape = NA, show.legend = FALSE) +
  ggplot2::geom_jitter(ggplot2::aes(Status1, y = TotalBCvolume, color = Cell_status1), cex = 2.0, alpha = 0.7, position = position_jitterdodge(0.2,0.2,0.7)) + P +
  ggplot2::theme_bw() + theme(axis.text = element_text(size=14, colour = "black")) +
  theme(axis.title = element_text(size=15, face = "bold"), panel.grid.major.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.minor.y = element_blank(), legend.title = element_blank(), legend.position = c(0.2,0.9), legend.direction = "horizontal", legend.box.background = element_rect(size = 1.0)) + ylab("Volume of Bile canaliculi (microns^3)") + xlab("Salicylate treatment") +
  ggplot2::ggsave("BC_Vol_5pix1.png", path = "/media/lab-admin/data/Lakshmi/Tubeness_infected_uninfected/Analysis/graphs_new_dec17", width = 8, height = 8, units = "in", dpi = 300)+
  ggplot2::ggsave("BC_Vol_5pix1.svg", path = "/media/lab-admin/data/Lakshmi/Tubeness_infected_uninfected/Analysis/graphs_new_dec17", width = 8, height = 8, units = "in", dpi = 300)
```
...
# Inside "geom_jitter" aes give the "shape = column name(Set)" to different the various experiments
ggplot2::ggplot(dat_5pix) +
  ggplot2::geom_boxplot(ggplot2::aes(Status1, Totallength, fill = Cell_status), size = 1.0, alpha = 0.0, width = 0.4, position = position_dodge(width = 0.7), varwidth = F, notch = T, outlier.shape = NA, show.legend = FALSE) +
  ggplot2::geom_jitter(ggplot2::aes(Status1, y = Totallength, color = Cell_status1), cex = 2.0, alpha = 0.7, position = position_jitterdodge(0.2,0.2,0.5)) + P +
  ggplot2::theme_bw() + theme(axis.text = element_text(size=14, colour = "black")) +
  theme(axis.title = element_text(size=15, face = "bold"), panel.grid.major.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.minor.y = element_blank(), legend.title = element_blank(), legend.position = c(0.2,0.9), legend.direction = "horizontal", legend.box.background = element_rect(size = 1.0)) + ylab("Total length of Bile canaliculi (microns^3)") + xlab("Salicylate treatment") +
  ggplot2::ggsave("BC_totleng_5pix1.png", path = "/media/lab-admin/data/Lakshmi/Tubeness_infected_uninfected/Analysis/graphs_new_dec17", width = 8, height = 8, units = "in", dpi = 300)+
  ggplot2::ggsave("BC_totleng_5pix1.svg", path = "/media/lab-admin/data/Lakshmi/Tubeness_infected_uninfected/Analysis/graphs_new_dec17", width = 8, height = 8, units = "in", dpi = 300)
```
