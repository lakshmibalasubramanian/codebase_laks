...
ggplot2::ggplot(dat_5pix) +
  ...
  ggplot2::geom_jitter(ggplot2::aes(Status1, y = Numberofbranches, color = Cell_status1), cex = 2.0, alpha = 0.9, position = position_jitterdodge(0.2,0.2,0.7)) + P + 
  ggplot2::theme_bw() + theme(axis.text = element_text(size=14, colour = "black")) +
  theme(axis.title = element_text(size=15, face = "bold"), panel.grid.major.x = element_blank(), panel.grid.major.y = element_blank(), panel.grid.minor.x = element_blank(), panel.grid.minor.y = element_blank(),  legend.title = element_blank()) +ylab("Number of branch points in Bile canaliculi") + xlab("Salicylate treatment") +
